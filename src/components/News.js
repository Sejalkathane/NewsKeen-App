...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=928f2c1b016f4b068d53200a9f33b4fa&page=1&pageSize=3";
    ...
    handlePrevClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=928f2c1b016f4b068d53200a9f33b4fa&page=${this.state.page - 1}&pageSize=3`;
        this.setState({ loading: true });
        let data = await fetch(url);
        let parsedata = await data.json();
