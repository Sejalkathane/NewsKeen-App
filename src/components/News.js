        ...
        return (
            <div className="container my-3">
               ...
               <div className="row">
                ...
                <NewsItem title="myTitle" description="myDescription" imageUrl="https://media.cnn.com/api/v1/images/stellar/prod/230115050553-02-pokhara-plane-crash-011523.jpg?c=16x9&q=w_800,c_fill" newsUrl="todo" />
                </div>
